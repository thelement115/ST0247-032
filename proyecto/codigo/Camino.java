...
public class Camino {
     ...
     */
    public ArrayList <Vertice> mejorSolucion(ArrayList<Vertice> clientes, Graph g, Vertice deposito, Double Tmax, Double vel, Double customer, Double carga, Double gasto, ArrayList<Carga> cargas){
        ArrayList <Vertice> visitados = new ArrayList<>(); // arraylist para manejar los visitados
        ArrayList <Vertice> solucion0 = new ArrayList<>();
        double [] totales1 = new double [5]; // guarda el peso total de los caminos
        totales1[0] = solucion(visitados,g,clientes,solucion0,deposito,Tmax,vel,customer,carga,gasto,cargas); // primera solucion //n^2+(n*x)
        ArrayList <Vertice> solucion1 = new ArrayList<>(); //c
        visitados.clear(); //c
        totales1[1] = solucion2(visitados,g,clientes,solucion1,deposito,Tmax,vel,customer,carga,gasto,cargas); //n^2+(n*x)
        if(totales1[0] < totales1[1]){ //c
...
//            System.out.println("totales 1 "+ totales1[1]);
     ...
     * @return una solucion
     */
    public double solucion (ArrayList <Vertice> v, Graph g, ArrayList <Vertice> c, ArrayList <Vertice> so,Vertice in,Double Tmax,Double vel, Double cu,Double ca,Double ga,ArrayList <Carga> car){ //n^2+(n*x)
         double total =0; //c
         double time =0; //c
     ...
     * @return una solucion
     */
    public double solucion2 (ArrayList <Vertice> v, Graph g, ArrayList <Vertice> c, ArrayList <Vertice> so,Vertice in,Double Tmax,Double vel, Double cu,Double ca,Double ga,ArrayList <Carga> car){
        double total =0;
        double time =0;
        double cargaMax = ca;
        Vertice n = in;
